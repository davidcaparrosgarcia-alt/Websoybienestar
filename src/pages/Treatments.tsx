...
export default function Treatments() {
  ...
  return (
    <div className="flex-1 w-full bg-transparent text-on-surface flex flex-col min-h-screen">
      <SEO
        title="Tratamientos online | ReprogrÁmate e HipnoDigest | SoyBienestar"
        description="Conoce los tratamientos online de SoyBienestar.es: ReprogrÁmate, programa terapéutico emocional de 3 meses, e HipnoDigest, hipnosis digestiva acompañada con nutrición personalizada."
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          >
            <Link to="/hipnodigest" className="block h-64 sm:h-80 overflow-hidden relative group/image" aria-label="Ver programa HipnoDigest">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end p-6 md:p-8">
                <span className="inline-flex items-center rounded-full bg-[#162839]/50 text-white/85 backdrop-blur-md border border-white/20 px-4 py-2 text-xs md:text-sm font-label font-medium tracking-wide shadow-lg">
                  Armoniza tu eje intestino-cerebro para SerBienestar
                </span>
              </div>
            </Link>
            <div className="p-8 sm:p-10 flex-grow flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <h2 className="font-headline text-3xl text-primary font-medium">HipnoDigest</h2>
