...
export default function Reprogramate() {
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "ReprogrÁmate",
        "item": "https://soybienestar.es/reprogramate"
      }
    ]
  };
  ...
  const treatmentsServiceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "@id": "https://soybienestar.es/reprogramate#service",
    "name": "Programa ReprogrÁmate",
    "serviceType": "Programa online de bienestar emocional",
    "provider": {
      ...
      <section className="relative flex items-center pt-16 pb-12 px-6 md:px-12 mx-auto max-w-screen-2xl overflow-hidden w-full">
        <div className="w-full">
          <div className="z-10 max-w-screen-xl">
            <h1 className="font-label text-secondary font-semibold tracking-widest uppercase text-xs mb-6 block break-words">Programa online de 3 meses de bienestar integral</h1>
            ...
            <div className="md:col-span-2 flex flex-col justify-center">
              ...
              <div className="space-y-3 max-w-2xl">
                <p className="text-lg text-on-surface-variant">
                  Un enfoque integral para navegar los diferentes estados de la niebla emocional.
                </p>
                <p className="text-base md:text-lg text-on-surface-variant/85 font-light leading-relaxed">
                  Todos los programas desbloquean en distinta medida algunas de las funciones y/o herramientas disponibles en esta web, además del curso de gestión de emociones.
                </p>
              </div>
            </div>
            <button
